...
- (CGFloat)height {
    ...
    if (_tempHeight == 0) {
        ...
        CGRect rect=[self.AcceptStation boundingRectWithSize:CGSizeMake(DWQScreenWidth - dwq_leftSpace - 2*dwq_rightSpace, CGFLOAT_MAX) options:NSStringDrawingTruncatesLastVisibleLine|NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:dict context:nil];
