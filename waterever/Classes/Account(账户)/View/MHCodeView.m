...
@interface MHCodeView()<UITextFieldDelegate>
{
...
- (void)addUnderLine {
    ...
    for (NSInteger i = 0; i < lineNum; i ++) {
        ...
        line.fillColor = [UIColor colorWithRed:204/255.0 green:204/255.0 blue:204/255.0 alpha:1].CGColor;
